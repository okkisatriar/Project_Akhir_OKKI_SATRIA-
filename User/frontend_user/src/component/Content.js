...
class Content extends Component {
  ...
  componentWillMount = () => {
    axios.get('http://localhost:8002/getNewProperty').then((getData) => {
  ...
  render() {
    const propertyBaru = this.state.propertibaru.map((isi, index) => {
      ...
      console.log(id)
      return <div className="col-md-4" style={{marginTop: 50}}>
      <div className="card">
            ...
            <div id="carouselExampleIndicators" className="carousel slide" data-ride="carousel">
              ...
              <div className="carousel-inner">
                <div className="carousel-item active">
                  <img className="d-block w-100" src="img/thumb-1920-435117.jpg" alt="First slide" />
                </div>
                <div className="carousel-item">
                  <img className="d-block w-100" src="img/thumb-1920-435117.jpg" alt="Second slide" />
                </div>
                <div className="carousel-item">
                  <img className="d-block w-100" src="img/thumb-1920-435117.jpg" alt="Third slide" />
                </div>
              </div>
